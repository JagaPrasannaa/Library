...
public class EmployeeController {
	...
	public String doLogin(Model model, @ModelAttribute("loginBean") Login loginBean) {
		model.addAttribute("msg", "Please Enter Your Details");
		return employeeService.doLogin(loginBean);
	}
	@RequestMapping(value = "/registeruser", method = RequestMethod.POST)
	public String doRegisterUser(Model model, @ModelAttribute("loginBean") Login loginBean) {
		if (loginBean != null && loginBean.getUname() != null && loginBean.getPassword() != null) {
			model.addAttribute("msg", "Registered Successfully");
			return employeeService.doRegisterUser(loginBean);
		} else {
